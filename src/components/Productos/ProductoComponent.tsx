...
const ProductoComponent:React.FC<Props> = ({producto}) => {
  return (
    <article className="bg-stone-700 py-5 px-5 flex max-w-fit flex-col gap-2 rounded-md border border-transparent hover:border-violet-600 hover:ease-in duration-150">
